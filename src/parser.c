...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [1053] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_declaration, 5, .production_id = 54),
  [1055] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__source_file_verbose, 5),
  ...
  [1069] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_declaration, 5, .production_id = 55),
  [1071] = {.entry = {.count = 1, .reusable = true}}, SHIFT(522),
  [1073] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_footer, 5, .production_id = 19),
  [1075] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_static_block_def, 2),
  [1077] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constructor_declaration, 2, .production_id = 21),
  [1079] = {.entry = {.count = 1, .reusable = true}}, SHIFT(616),
  [1081] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_declaration_plain, 4, .production_id = 12),
  [1083] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_declaration_plain_body, 3),
  [1085] = {.entry = {.count = 1, .reusable = true}}, SHIFT(626),
  [1087] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_declaration_plain, 4, .production_id = 9),
  [1089] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_declaration_plain, 4, .production_id = 8),
  [1091] = {.entry = {.count = 1, .reusable = true}}, SHIFT(524),
  [1093] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_declaration_plain, 4, .production_id = 11),
  [1095] = {.entry = {.count = 1, .reusable = true}}, SHIFT(523),
  [1097] = {.entry = {.count = 1, .reusable = true}}, SHIFT(133),
  [1099] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_def_plain, 4, .production_id = 11),
  [1101] = {.entry = {.count = 1, .reusable = true}}, SHIFT(658),
  [1103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_def_plain, 4, .production_id = 10),
  [1105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_def_plain, 5, .production_id = 22),
  [1107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_runtime_annotation_element_value_tag, 1),
  [1109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_path, 3),
  ...
  [1219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_path, 1),
  [1221] = {.entry = {.count = 1, .reusable = true}}, SHIFT(443),
  [1223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header_info, 2),
  ...
  [1233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_footer_runtime_visible_annotation_element_args, 2),
  [1235] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [1237] = {.entry = {.count = 1, .reusable = true}}, SHIFT(613),
  [1239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_declaration_plain, 6, .production_id = 42),
  [1241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_footer, 7, .production_id = 53),
  [1243] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [1245] = {.entry = {.count = 1, .reusable = true}}, SHIFT(336),
  [1247] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_signature, 3),
  [1249] = {.entry = {.count = 1, .reusable = true}}, SHIFT(590),
  [1251] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_def_plain, 6, .production_id = 44),
  [1253] = {.entry = {.count = 1, .reusable = true}}, SHIFT(510),
  [1255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_def_plain, 6, .production_id = 43),
